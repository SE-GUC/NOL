...
var { subscrption } = require('../../models/subscrptionController');
...
router.get('/get/subscrption', (req, res) => {
...
router.post('/create/subscrption',(req, res) => {
    var subscrption = new subscrptions({
        email: req.body.email,
      
    });
    subscrption.save();
    res.send(subscrption); 
});
